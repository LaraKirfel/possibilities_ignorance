...
# Density plot showing the distribution of participant's judgments in scenario 5 (potential use for CogSci paper)
...
##### Correlation plot of difference in modal distance and force judgments (used to be in CogSci Paper)
...
ggsave("figModalDistanceMean.pdf", plot = modalmeans_plot2, 
